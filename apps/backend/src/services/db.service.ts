import { type Dialect, Model, type ModelStatic, Sequelize } from 'sequelize';
...
Piece.prototype.getModel = Piece.prototype.model$ =
...
export default class DBService extends Service {
  ...
  private models: {
     ...
     * Model instance
     */
    modelInstance: ModelStatic<Model>;
    /**
     * Model constructor
     */
   ...
   * @returns Model item
   */
  public getModel<M extends ModelConstructor>(
    modelConstructor: M,
  ): ReturnType<M> {
    // Model item
    const modelItem = this.models.find(
      (m) => m.modelConstructor === modelConstructor,
    );
